...
fruit_data_names_and_attributes = [('calories', 'Calories'), ('calories_from_fat', 'Calories from Fat'), ('total_fat_g', 'Total Fat (g)'), ('total_fat_dv', 'Total Fat (%DV)'), ('sodium_mg', 'Sodium milli(g)'), ('sodium_dv', 'Sodium (%DV)'), ('potassium_g', 'Potassium (mg)'), ('potassium_dv', 'Potassium (%DV)'), ('total_carbohydrate_g', 'Total Carbohydrate (g)'), ('total_carbohydrate_dv', 'Total Carbohydrate (%DV)'), ('dietary_fiber_g', 'Dietary Fiber (g)'), ('dietary_fiber_dv', 'Dietary Fiber (%DV)'), ('sugars_g', 'Sugars (g)'), ('protein_g', 'Protein (g)'), ('vitamin_a_dv', 'Vitamin A (%DV)'), ('vitamin_c_dv', 'Vitamin C (%DV)'), ('calcium_dv', 'Calcium (%DV)'), ('iron_dv', 'Iron (%DV)')]
